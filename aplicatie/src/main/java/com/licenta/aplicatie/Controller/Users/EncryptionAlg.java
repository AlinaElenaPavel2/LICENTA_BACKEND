...
public class EncryptionAlg implements AttributeConverter<String, String> {

    private static final String AES = "AES";
    private static final byte[] encryptionKey = "P(B)K-F2Wh7macS+".getBytes();

    private final Cipher encryptCipher;
    private final Cipher decryptCipher;

    public EncryptionAlg() throws Exception {
